...
import { features, organizationFeatures, organizationMemberships } from './schema.js';
        ...
        try {
            ...
            if (query.orgId) {
                const orgFeature = await db
                    ...
                    .where(and(eq(organizationFeatures.organizationId, query.orgId), eq(organizationFeatures.featureId, featureRecord.id)))
                    .limit(1);
